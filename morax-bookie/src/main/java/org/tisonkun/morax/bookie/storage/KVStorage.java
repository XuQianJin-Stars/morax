...
public interface KVStorage extends Closeable {
     ...
     *
     * @param key   the key to lookup
     * @param value an array where to store the result
     * @return -1 if the entry was not found or the length of the value
     * @throws IOException if the value array could not hold the result
     */
     ...
     *
     * @param firstKey the first key in the range (included)
     * @param lastKey  the last key in the range (not included)
     */
     ...
     *
     * @param firstKey the first key in the range (included)
     * @param lastKey  the lastKey in the range (not included)
     */
